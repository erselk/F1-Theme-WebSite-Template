  ...
  return (
    <div className="flex flex-wrap items-center gap-2 text-sm">
      ...
      <button 
        ...
        className="bg-carbon-grey hover:bg-electric-blue text-white rounded-full p-2 transition-colors"
      ...
      <button 
        ...
        className="bg-carbon-grey hover:bg-neon-red text-white rounded-full p-2 transition-colors"
      ...
      <button 
        ...
        className="bg-carbon-grey hover:bg-neon-green text-white rounded-full p-2 transition-colors"
      ...
      <button 
        ...
        className="bg-carbon-grey hover:bg-[#25D366] text-white rounded-full p-2 transition-colors"
      ...
      <button 
        ...
        className="flex items-center gap-1 bg-carbon-grey hover:bg-electric-blue text-white rounded-full px-3 py-1 transition-colors ml-1"
