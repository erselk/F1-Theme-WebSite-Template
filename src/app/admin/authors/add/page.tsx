  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Yeni Yazar Ekle</h1>
        <Link 
          href="/admin/authors" 
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-6 mb-6">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 relative overflow-hidden rounded-full border-2 border-gray-300 flex-shrink-0">
                  <Image
