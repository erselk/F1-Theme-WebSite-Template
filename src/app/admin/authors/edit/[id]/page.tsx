...
export default function EditAuthorPage({ params }: { params: { id: string } }) {
    ...
    return (
      <div className="container mx-auto px-4 py-8 flex justify-center">
        <div className="flex flex-col items-center">
          ...
          <span className="text-medium-grey">Yazar bilgileri yükleniyor...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className={`p-6 rounded-lg shadow-md ${isDark ? 'bg-dark-grey' : 'bg-white'}`}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="w-24 h-24 relative overflow-hidden rounded-full border-2 border-gray-300">
                <Image
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-xs text-medium-grey">
                  Önerilen boyut: 400x400 piksel, maksimum dosya boyutu: 2MB
                </p>
              </div>
            </div>
          </div>
