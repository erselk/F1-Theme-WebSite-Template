  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4">
      ...
      <section className="mb-8 sm:mb-12 md:mb-16">
        <h2 className="text-2xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 md:mb-6 text-dark-grey dark:text-light-grey">
      ...
      <section className="mb-8 sm:mb-12 md:mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-8">
          <div className="bg-very-light-grey dark:bg-graphite p-3 sm:p-4 md:p-6 rounded-lg shadow-md border border-light-grey dark:border-carbon-grey">
            <div className="text-xl sm:text-2xl mb-1 sm:mb-2">🎧</div>
            <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-dark-grey dark:text-light-grey">
      ...
      <section>
        ...
        <div className="bg-very-light-grey dark:bg-graphite p-4 sm:p-6 md:p-8 rounded-lg shadow-md border border-light-grey dark:border-carbon-grey">
          <p className="text-sm sm:text-base md:text-lg mb-3 sm:mb-4 text-medium-grey dark:text-silver">
            {language === 'tr' ? 
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
            <div>
              <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2 text-dark-grey dark:text-light-grey">
                {language === 'tr' ? 'İletişim Bilgilerimiz' : 'Contact Information'}
              </h3>
              <p className="text-xs sm:text-sm md:text-base mb-1 text-medium-grey dark:text-silver">
