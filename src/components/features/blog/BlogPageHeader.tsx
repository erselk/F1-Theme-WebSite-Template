...
const BlogPageHeader: React.FC = () => {
  ...
  return (
    <div className="mb-12 text-center">
      <h1 className="font-titillium-web text-4xl font-bold mb-4 text-dark-grey dark:text-light-grey">
        {language === 'tr' ? 'Blog' : 'Blog'}
      </h1>
      <p className="font-inter text-xl text-medium-grey dark:text-silver max-w-3xl mx-auto">
        {language === 'tr' 
