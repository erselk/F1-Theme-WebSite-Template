...
const SimulatorsSection = ({ simulators, translations }) => {
            ...
            >
              <div className="relative z-10">
                <div className="flex items-start gap-1 sm:gap-2 mb-1 sm:mb-2">
                  ...
                  >
                    <simulator.icon className="h-2 w-2 sm:h-4 sm:w-4 md:h-5 md:w-5 lg:h-6 lg:w-6 text-white" />
                  </motion.div>
